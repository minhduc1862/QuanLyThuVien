...
namespace QuanLyThuVien
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-18H2KMR;Initial Catalog=quanlythuvien;Integrated Security=True");
        ...
        public string taoID(string preFix, string sql)
        {
            string id = "";
            int countRow = -1;
